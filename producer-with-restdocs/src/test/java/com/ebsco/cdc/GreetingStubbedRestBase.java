...
// **************************************************************************************************************
// This class is not used in any of the autogenerated tests becuase of the naming convention used by
// spring cloud contract. GreetingRestBase will be the actual one in use by Spring Cloud Contract's Verifier.

// This class can be substitutied as a base class and is provided here as an example to show the developer
// how mocks can be used to successfully validate the contracts during the build. If no mocks or service implementations are
// provided, spring cloud contract verifier would fail the build.
// ***************************************************************************************************************
public abstract class GreetingStubbedRestBase {
